...
symbols = [
    ...
    # BEGIN ethantkoenig EDIT
    Symbol(")", ["R paren", "right paren"], ["round"]),
    # END ethantkoenig EDIT
    Symbol("[", None,["brack", "L brack", "bracket", "L bracket", "left bracket", "square", "L square", "left square",],),
    # BEGIN ethantkoenig EDIT
    Symbol("]", None, ["R brack", "R bracket", "right bracket", "R square", "right square", "box"]),
    # END ethantkoenig EDIT
    Symbol("/", ["forward slash"], ["slash"]),
    Symbol("\\", None, ["backslash"]),
    Symbol("{", None, ["brace", "L brace", "left brace", "curly bracket", "left curly bracket"],),
    # BEGIN ethantkoenig EDIT
    Symbol("}", None, ["R brace", "right brace","R curly bracket", "right curly bracket", "curly"]),
    # END ethantkoenig EDIT
    Symbol("<", None, ["angle", "L Angle", "left angle", "less than"]),
    # BEGIN ethantkoenig EDIT
    Symbol(">", None, ["rangle", "R angle", "right angle", "greater than", "diamond"]),
    # END ethantkoenig EDIT
    Symbol("^", None, ["caret"]),
    Symbol("|", None, ["pipe"]),
    # BEGIN ethantkoenig EDIT
    Symbol("'", None, ["quote", "apostrophe", "twin"]),
